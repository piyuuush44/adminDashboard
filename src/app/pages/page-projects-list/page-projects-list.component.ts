...
export class PageProjectsListComponent implements OnInit {
    ...
    constructor(private sidebarService: SidebarService, private cdr: ChangeDetectorRef, private authService: AuthService) {
    ...
    ngOnInit() {
        ...
        this.usersArray = this.authService.fetchUsers();
    }
